...
from .losses_dac import MelSpectrogramLoss
...
class AutoencoderTrainingWrapper(pl.LightningModule):
    def __init__(
        ...
        if self.teacher_model is not None:
            ...
            # self.gen_loss_modules += [
            #     AuralossLoss(self.mel, 'reals', 'decoded', name='mel_loss', weight=0),
            # ]
...
class AutoencoderDemoCallback(pl.Callback):
    ...
    def on_train_batch_end(self, trainer, module, outputs, batch, batch_idx): 
        ...
        try:
            ...
            filename = f'training_samples/recon_{trainer.global_step:08}.wav'
